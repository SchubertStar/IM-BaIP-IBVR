...
cp "/scratch/$USER/nexusYolo/finalbig.v1i.yolov11.tar.gz" "$TMPDIR"
cd "$TMPDIR"
tar -xzf finalbig.v1i.yolov11.tar.gz
WORKDIR="$TMPDIR/finalbig.v1i.yolov11"
cd "$WORKDIR"
